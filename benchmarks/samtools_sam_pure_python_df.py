...
def write_read_dict(read_df: dict, csv_path: str) -> None:
    '''
    Write read dict to csv
    '''

    read_df.to_csv(csv_path)
...
def main(args):
    ...
    write_read_dict(read_df, f'samtools_pure_{output_name}.csv')
